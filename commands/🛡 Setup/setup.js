            ...
            message.guild.channels.create(`🎧｜Music`, {
                ...
                message.guild.channels.create(`🎵｜Requests`, {
                    ...
                    let dusra = new MessageEmbed()
                        ...
                        .setThumbnail(client.user.displayAvatarURL())
                        .setAuthor(message.author.username)
                        .setTitle("CrimeX Music - Best Free Music Bot of 2021")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite CrimeX Music](https://discord.com/oauth2/authorize?client_id=815096241104486401&permissions=37219648&scope=bott) • [Join Server](https://discord.gg/ATV8pZCXqH) • [Subscribe Now](https://www.youtube.com/channel/UCZHJssQhjRThAZ6riUS5Mxg)`)
