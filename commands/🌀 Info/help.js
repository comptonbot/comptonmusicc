    ...
    run: async (client, message, args) => {
        ...
        if (!args[0]) {
            ...
            const embed = new MessageEmbed()
                .setTitle("<a:778521981468540960:891240754993844244> \` Welcome to My Help Menu \` <a:778521981468540960:891240754993844244>")
                .addField('Prefix Information', `Prefix: \`${config.prefix}\`\nYou can also mention ${client.user} to get prefix info.`, false)
                .addFields(categories)
                .setImage('https://share.creavite.co/9foO8dqpW017RnHQ.gif')
                .setDescription(
